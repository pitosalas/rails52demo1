...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post translations_url, params: { translation: { contents: @translation.contents, to_lang: @translation.to_lang, translation: @translation.translation } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { content: @translation.content, to_lang: @translation.to_lang, translation: @translation.translation } }
